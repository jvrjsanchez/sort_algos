...
client = OpenAI(api_key = 'coloque-aqui-sua-chave')
...
# Função para analisar o sentimento de uma lista de notícias
def dsa_analisa_sentimento(news_list):
    ...
    for news in news_list:
        ...
        # Define um prompt para o modelo GPT analisar o sentimento do título da notícia
        prompt = f"Classifique o sentimento do seguinte título de notícia sobre a Apple como 'positivo', 'negativo' ou 'neutro': \"{news}\""
        
        # Envia o prompt ao modelo de IA e obtém a resposta
        ...
        # Extrai o conteúdo da resposta e converte para minúsculas
