...
main()
{
	...
	// Objeto para receber o conteudo do arquivo
	ifstream inputFile;

	// Abre o arquivo
	inputFile.open(fileName);

	// Verifica se ha algum erro
	...
	// Variaveis escalares do tipo double para tratar os valores de coluna
	double idVal;
	double tipo_docVal;
	double classeVal;
	...
	// Variaveis do tipo vetor para todos os elementos de cada coluna do dataset
	vector<double> id;
	...
	// Variavel para armazenar o cabecalho do arquivo
	string header;

	// Variavel para armazenar cada celula do arquivo csv
	string cell;

	// Recupera o cabecalho para desconsiderar a linha
	...
	while (inputFile.good())
	{
		...
		// Agora seguimos fazendo a leitura somente das celulas com valores
		if (!cell.empty())
		{
			...
			// Referencia: http://www.cplusplus.com/reference/vector/vector/push_back/
			id.push_back(idVal);
	...
	// Inicia a medicao do tempo de execucao
	auto start = high_resolution_clock::now();

	cout << "Iniciando a Execucao do Algoritmo" << endl
		 << endl;

	// Fazemos a divisao dos dados criando os vetores de treinamento
	...
	// Fazemos a divisao dos dados criando os vetores de teste
	...
	// Comeco do Algoritmo Naive Bayes
	...
	// Likelihood (Probabilidade) para variavel certificado_valido
	// Matriz 2x2
	...
	// Media e variancia da variavel uso_dias
	// Matriz 1x2
	...
	// Media da variavel uso_dias
	cout << "uso_dias Mean: " << endl;
	print2DVector(uso_dias_mean);
	cout << endl;

	// Variancia da variavel uso_dias
	...
	// Registra a conclusao do algoritmo
	std::chrono::duration<double> elapsed_sec = stop - start;
	cout << "Tempo de Execucao: " << elapsed_sec.count() << endl
		 << endl;
